...
export const loadout: LoadoutGroup[] = [
    ...
    items: [
      {
        ...
        whatFor: '16 cores for compiling, running local models, and never thinking about CPU again.',
        take: 'Overkill is the right amount when you run a model and three dev servers at once.',
      },
      {
        name: 'NVIDIA RTX 4080 Super',
        whatFor: 'Local inference, the occasional game, and encoding the stream without dropping frames.',
        take: 'Enough VRAM to run decent local models and still stream in 1080p60.',
      },
      {
        name: '64GB DDR5-6000',
        whatFor: 'Because Chrome, Docker, an LLM, and OBS all want to be friends at the same time.',
        take: 'RAM is cheap; closing tabs is expensive. Easy call.',
      },
      {
        name: '2TB NVMe (Gen4)',
        whatFor: 'OS, projects, and a graveyard of node_modules folders.',
  ...
  },
  {
    ...
    items: [
      {
        name: 'Dual 27" 1440p',
        whatFor: 'Code on one, stream/chat/docs on the other.',
        take: 'Two screens is the minimum tax for living in a terminal and a browser at once.',
      },
      {
        name: 'Shure SM7B + interface',
        whatFor: 'Stream and recording audio that doesn\'t make people leave.',
        take: 'Good audio is the cheapest upgrade to looking like you know what you\'re doing.',
      },
      {
        name: 'Mechanical keyboard',
        whatFor: 'All day every day. Tactile switches, because I need the feedback.',
        take: 'The one piece of gear I\'m genuinely picky about. Worth it.',
      },
    ],
  },
]
